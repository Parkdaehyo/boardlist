...
public class BoardController {
	...
	public String content3(@PathVariable Integer boardNo, HttpSession session, Model model,
		...
		String boardno3 = request.getParameter("boardNo"); // 이거 null값인데??

		System.out.println("boardno3이 뭔데?" + boardno3);
...
////////////////////////////첨부파일 write Get요청
	@GetMapping("/write3")
	public void write3(@RequestParam("page") int page, Model model, @ModelAttribute("p") SearchVO paging) { // void로
																											// 처리하면 알아서
		// board/write3.jsp가// 열린다.
